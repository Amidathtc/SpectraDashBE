...
ProfileRouter.route("/:userID/:profileID/update-profile-avatar").patch(multer_1.upload, profileController_1.updateProfileAvatar);
ProfileRouter.route("/view-all-profiles").get(profileController_1.ViewAllProfiles);
